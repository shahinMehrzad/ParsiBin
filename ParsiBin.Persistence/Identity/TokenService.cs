...
using ParsiBin.Application.Identity.Tokens;
...
namespace ParsiBin.Persistence.Identity
{
    internal class TokenService : ITokenService
    {
        ...
        private IEnumerable<Claim> GetClaims(ApplicationUser user, string ipAddress) =>
            ...
            new(ParsiBinClaims.Fullname, $"{user.FirstName} {user.LastName}"),
            new(ClaimTypes.Name, user.FirstName ?? string.Empty),
            new(ClaimTypes.Surname, user.LastName ?? string.Empty),
            new(ParsiBinClaims.IpAddress, ipAddress),
            new(ParsiBinClaims.ImageUrl, user.ImageUrl ?? string.Empty),
